...
var Relationship = {
  !function (s, f) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = f() : "function" == typeof define && define.amd ? define(f) : (s = "undefined" != typeof globalThis ? globalThis : s || self).relationship = f()
  }
  (this, (function () {
      "use strict";
      function s(s, f) {
        (null == f || f > s.length) && (f = s.length);
        for (var x = 0, d = Array(f); x < f; x++)
          d[x] = s[x];
        return d
      }
      function f(f, x) {
        if (f) {
          ...
          return "Object" === d && f.constructor && (d = f.constructor.name),
          "Map" === d || "Set" === d ? Array.from(f) : "Arguments" === d || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(d) ? s(f, x) : void 0
        }
      }
      function x(x) {
        return function (f) {
          ...
          if (Array.isArray(s) || (x = function (s, f) {
              if (s) {
                if ("string" == typeof s)
                  return b(s, f);
                  var x = {}
                  .toString.call(s).slice(8, -1);
                  return "Object" === x && s.constructor && (x = s.constructor.name),
                  "Map" === x || "Set" === x ? Array.from(s) : "Arguments" === x || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(x) ? b(s, f) : void 0
                }
              }
      ...
      function h(s, x) {
        ...
        (s) || function (s, f) {
          ...
          if (null != x) {
            ...
            h = !1;
            try {
              if (b = (x = x.call(s)).next, 0 === f) {
                if (Object(x) !== x)
                  return;
                e = !1
              } else
                for (; !(e = (d = b.call(x)).done) && (r.push(d.value), r.length !== f); e = !0);
            } catch (s) {
              h = !0,
              m = s
            } finally {
              try {
                if (!e && null != x.return && (o = x.return(), Object(o) !== o))
                  return
              } finally {
                if (h)
                  throw m
      ...
      var p = {},
      $ = function (s) {
        V(s).forEach((function (f) {
            p[f] = n[s]
          }))
      };
      for (var v in n)
        $(v);
      for (var W in c = Object.assign({}, c, function (s, f) {
          var x = {},
          d = function () {
            var d = m.match(/\{.+?\}/)[0],
            b = f[m],
              ...
              if (!["h,h", "w,w", "w,h", "h,w"].some((function (s) {
                ...
                f.forEach((function (s) {
                    b.forEach((function (f) {
                        f.includes("?") ? e.push(f.replace("?", s)) : e.push(s + f)
                      }))
                  })),
                x[o] || (x[o] = c[o] || []),
                x[o] = e.concat(x[o])
            ...
            (i, p)), a)c[W] = [].concat(a[W], c[W] || []);
    c.o = ["passer-by.com", "作者"];
    var g = {
      w: ["妻", "内", "岳", "岳家", "丈人"],
      h: ["夫", "外", "公", "婆家", "婆婆"]
    },
    y = new Set(Object.values(c).flat());
    for (var S in c)
      if (S.match(/^[fm]/) || S.match(/^[olx][bs]$|^[olx][bs],[^mf]/)) {
        var E = function () {
          var s = j + "," + S;
          if (S.match(/[fm]/)) {
            var f = s.replace(/,[ol]([sb])(,[wh])?$/, ",x$1$2").replace(/(,[sd])&[ol](,[wh])?$/, "$1$2");
            if (f != s && c[f])
              return 1
          }
          c[s] || (c[s] = []);
    ...
    function I(s, f) {
      ...
      d = "";
      s.match(/&o$/) ? d = "&l" : s.match(/&l$/) && (d = "&o"),
      s = s.replace(/&[ol\d+]/g, ""),
      f < 0 && (s.match(/^w/) ? f = 1 : s.match(/^h/) && (f = 0));
      var m = function (f) {
        var m = ("," + f + "," + s).replace(/,[fhs]|,[olx]b/g, ",1").replace(/,[mwd]|,[olx]s/g, ",0"),
        b = (m = m.substring(0, m.length - 2)).split(",").reverse(),
        o = s.split(",").reverse().map((function (s, f) {
              return x[s][b[f]]
            })).join(",");
        return o + (C(o) ? "" : d)
      };
      return f < 0 ? [m(1), m(0)] : [m(f)]
    }
    function T(s) {
      ...
      if (s.match(/&([\d]+)(,[hw])?$/)) {
        var d = function (s) {
          ...
          if (x[s])
            ...
            var d = ~~(s / 10),
            m = s % 10;
            f = (d ? (l[d] + "十").replace("一十", "十") : "") + l[m]
          }
          return f
        }
        (s.match(/&([\d]+)(,[hw])?$/)[1]);
        if (s = s.replace(/&\d+/g, ""), w[s]) {
          var m = w[s][0].replace("几", d);
          f.push(m)
        } else if (N[s]) {
          var b = C(s),
          o = "";
          b < 3 && !s.match(/[hw],/) && (N[s].forEach((function (s) {
                !o && s.includes("几") && (o = s.replace("几", d))
              })), o || (o = (o = N[s][0]).match(/^[大小]/) ? o.replace(/^[大小]/, d) : d + o)),
          f.push(o)
        }
      }
      if (f.length || (f = x(s = s.replace(/&\d+/g, ""))), f.length || (f = x(s = s.replace(/&[ol]/g, ""))), f.length || (f = x(s = s.replace(/[ol](b|s)/g, "x$1"))), !f.length) {
        var r = s.replace(/x/g, "l"),
        e = s.replace(/x/g, "o");
        f = f.concat(x(e), x(r))
      }
      return f
    ...
    function q(s) {
      ...
      return f > -1 && U[f + "," + s] && (0 == f ? x = "(女性)" + x : 1 == f && (x = "(男性)" + x)),
      x
    }
    var z = {
      xb: ["兄弟", "亲兄弟", "同胞兄弟"],
        ...
        if (Array.isArray(s) || (x = function (s, f) {
            if (s) {
              if ("string" == typeof s)
                ...
                .toString.call(s).slice(8, -1);
                return "Object" === x && s.constructor && (x = s.constructor.name),
                "Map" === x || "Set" === x ? Array.from(s) : "Arguments" === x || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(x) ? P(s, f) : void 0
              }
            }
              (s)) || f && s && "number" == typeof s.length) {
            x && (s = x);
    ...
    function Q(s) {
      ...
      for (var f = (s = (s = (s = s.replace(/(舅|姑)+(爸|父|丈|妈|母)?家的?(哥|姐|弟|妹)+/, "$1表$3").replace(/(舅|姑)+(爸|父|丈|妈|母)?家的?/, "$1表")).replace(/(伯|叔)+(父|母)?家的?(哥|姐|弟|妹)+/, "堂$3").replace(/(伯|叔)+(父|母)?家的?/, "堂")).replace(/姨+(爸|父|丈|妈|母)?家的?(哥|姐|弟|妹)+/, "姨$2").replace(/姨+(爸|父|丈|妈|母)?家的?/, "姨")).split("的"), x = [], d = !0, m = function () {
        var s = f.shift(),
        m = [],
        b = [s],
        o = function (s) {
          for (var f in r.forEach((function (f) {
                f.arr.forEach((function (x) {
                    var d = s.replace(f.exp, x);
                    d != s && (b.push(d), o(d))
                  }))
              })), e) {
            var x = s.replace(f, e[f]),
            d = s.replace(e[f], f);
            x != s && b.push(x),
            d != s && b.push(d)
          }
        ...
        b.forEach((function (s) {
            var f = (s = s.replace(/^[尕幺细满碎晚末尾幼]/, "小")).match(/^[大|小]|^[一|二|三|四|五|六|七|八|九|十]+/);
            if (f) {
              ...
              b = function (s) {
                ...
                if (x[s])
                  ...
                  var d = h(s.replace(/^十/, "一十").split("十").map((function (s) {
                          return l.indexOf(s)
                        })).reverse(), 2),
                  m = d[0],
                  b = d[1];
              ...
              [x, d, s].forEach((function (s, f) {
                  ...
                  x && x.length && x.forEach((function (x) {
                      var d = x.replace(/(,[hw])$/, "&" + b + "$1").replace(/([^hw]+)$/, "$1&" + b);
                      x.match(/^[mf,]+$/) || s.match(/^[从世]/) || t[f].push(d)
                    }))
                }))
            }
            m = m.concat(H[s] || [])
    ...
    function R(s) {
      ...
      if (d < 0) {
        var m = -1,
        b = -1;
        if (f.match(/^,[w1]/) ? b = 1 : f.match(/^,[h0]/) && (b = 0), x.match(/^,[w1]/) ? m = 1 : x.match(/^,[h0]/) && (m = 0), -1 == b && m > -1)
          d = m;
        else if (b > -1 && -1 == m)
          d = b;
        else {
      ...
      return o.forEach((function (f) {
          r.forEach((function (x) {
              var m = d,
              b = "," + x;
              if (b.match(/,([fhs1](&[ol\d]+)?|[olx]b)(&[ol\d]+)?$/) && (m = 1), b.match(/,([mwd0](&[ol\d]+)?|[olx]s)(&[ol\d]+)?$/) && (m = 0), f && x) {
                var o = s.optimal;
                if ((f.match(/&\d+/) || x.match(/&\d+/)) && (o = !0), o) {
                  var r = function (s) {
                    for (var f = s.from, x = s.to, d = s.sex, m = f.split(","), b = x.split(","), o = 0; o < m.length && o < b.length; o++) {
                      if (m[o] != b[o]) {
                        if (C(m[o]) == C(b[o]) && m[o].match(/^[xol][bs]|^[sd]/) && b[o].match(/^[xol][bs]|^[sd]/)) {
                          var r,
                          e,
                          h,
                          l;
                          if (m[o].replace(/&([ol\d]+)/, "").replace(/^[xol]([bs])/, "$1") != b[o].replace(/&([ol\d]+)/, "").replace(/^[xol]([bs])/, "$1"))
                            break;
                          var t = (null === (r = m[o].match(/&([ol\d]+)/)) || void 0 === r ? void 0 : r[1]) || (null === (e = m[o].match(/([ol])[bs]/)) || void 0 === e ? void 0 : e[1]) || "",
                          w = (null === (h = b[o].match(/&([ol\d]+)/)) || void 0 === h ? void 0 : h[1]) || (null === (l = b[o].match(/([ol])[bs]/)) || void 0 === l ? void 0 : l[1]) || "";
                          if (t && w)
                            isNaN(t) || isNaN(w) ? !isNaN(t) && "o" == w || "l" == t && !isNaN(w) ? m[o] = m[o].replace(/^[xol]b|^s/, "lb").replace(/^[xol]s|^d/, "ls") : (!isNaN(t) && "l" == w || "o" == t && !isNaN(w)) && (m[o] = m[o].replace(/^[xol]b|^s/, "ob").replace(/^[xol]s|^d/, "os")) : +t > +w ? m[o] = m[o].replace(/^[xol]b|^s/, "lb").replace(/^[xol]s|^d/, "ls") : +t < +w && (m[o] = m[o].replace(/^[xol]b|^s/, "ob").replace(/^[xol]s|^d/, "os")), f = m.slice(o).join(","), x = b.slice(o + 1).join(","), d = b[o].match(/^([fhs1](&[ol\d]+)?|[olx]b)(&[ol\d]+)?/) ? 1 : 0;
                          else if (s.optimal) {
                            var M,
                            n;
                            if (t = (null === (M = m[o].match(/([xol])[bs]/)) || void 0 === M ? void 0 : M[1]) || "", w = (null === (n = b[o].match(/([xol])[bs]/)) || void 0 === n ? void 0 : n[1]) || "", "x" == t || "x" == w) {
                              f = m.slice(o + 1).join(","),
                              x = b.slice(o + 1).join(","),
                              d = m[o].match(/^([fhs1](&[ol\d]+)?|[olx]b)(&[ol\d]+)?/) ? 1 : 0;
                              continue
                            }
                          }
                        }
        ...
        if (!x[s]) {
          ...
          do {
            ...
            try {
              for (r.s(); !(b = r.n()).done; ) {
                var e = b.value;
                if ((s = s.replace(e.exp, e.str)).includes("#"))
                  return s.split("#").forEach(d), !1
              }
            } catch (s) {
              r.e(s)
            } finally {
    ...
    function X(s, f) {
      ...
      if (f > -1 && !s.includes(",1") && !s.includes(",0") && (s = "," + f + s), s.match(/,[mwd0](&[ol\d]+)?,w|,[hfs1](&[ol\d]+)?,h/))
        return [];
      var x = V(s).map((function (s) {
    ...
    var Y = function (s) {
      ...
      !function (s) {
        if (N = Object.assign({}, A), s && O[s])
          for (var f in O[s])
            N[f] = [].concat(O[s][f], A[f] || [])
      }
      (f.mode);
      var b = Q(f.text),
      o = Q(f.target);
          ...
          o.forEach((function (x) {
              R({
                ...
                optimal: f.optimal
                  ...
                  (s ? X(s.selector, s.sex) : []).forEach((function (x) {
                      var d = [x],
                      m = s.sex;
                      f.reverse && (d = I(x, m), m = x.match(/([fhs1](&[ol\d]+)?|[olx]b)$/) ? 1 : 0),
                      "chain" == f.type ? d.forEach((function (f) {
                          var x = q(f, s.sex);
                          x && r.push(x)
                        })) : "pair" == f.type ? (d = I(x, s.sex)).forEach((function (s) {
                          var f = function (s, f) {
                            var x = [],
                            d = [],
                            m = [];
                            s = s.replace(/&\d+/g, ""),
                            f = f.replace(/&\d+/g, "");
                            var b = s.replace(/([ol])([bs])/g, "x$2"),
                            o = f.replace(/([ol])([bs])/g, "x$2"),
                            r = s.replace(/&[ol]/g, ""),
                            e = f.replace(/&[ol]/g, "");
                            for (var h in t) {
                              var l = h.split("#");
                              if (l.length > 1) {
                                ...
                                (w.includes(s) && M.includes(f) || w.includes(f) && M.includes(s)) && x.push(t[h][0]),
                                (n.includes(b) && a.includes(o) || n.includes(o) && a.includes(b)) && d.push(t[h][0]),
                                (n.includes(r) && a.includes(e) || n.includes(e) && a.includes(r)) && m.push(t[h][0])
                              }
                            }
                            return x.length || (x = d),
                            x.length || (x = m),
    ...
    return Y.data = N,
    Y.dataCount = Object.keys(N).length,
    Y.setMode = function (s, f) {
      O[s] = Object.assign(O[s] || {}, f)
    },
    Y
  }));
}
mergeInto(LibraryManager.library, Relationship);
